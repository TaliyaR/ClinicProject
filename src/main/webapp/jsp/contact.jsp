							...
							<div class="col-xs-8">
								<div class="menu-1">
									<ul>
										...
										<li class="active"><a href="/jsp/contact.jsp">Контакты</a></li>
									</ul>
								</div>
							</div>
			...
			<div class="row">
				<div class="col-md-12 animate-box">
					...
					<div class="row contact-info-wrap">
						<div class="col-md-3">
						<p><span><i class="icon-clock3"></i></span> Время работы: <br> Пн-Cб: 8:00 - 18:00<br>Вс - выходной</p>
					</div>
						<div class="col-md-3">
							<p><span><i class="icon-location"></i></span> Казань, <br> Кремлевская 35</p>
						</div>
						<div class="col-md-3">
							<p><span><i class="icon-phone"></i></span>+ 7 800 555 35 35</p>
						</div>
						<div class="col-md-3">
							<p><span><i class="icon-mail"></i></span>info@mail.ru</p>
						</div>
